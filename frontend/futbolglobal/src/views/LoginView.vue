<template>
  <div>
    ...
    <div class="w-full flex flex-col justify-center items-center bg-[#C72E22] py-[30px]">
        <div class="border-[1px] h-[25rem] w-[40rem] mt-[10vh] bg-[white] p-[10px] rounded-[30px]">
            <h1 class="text-[#C72E22] text-[50px] font-bold text-center">Iniciar Sesión</h1>
            <form @submit.prevent = logearUsuario  class="flex flex-col items-center justify-center gap-[30px] w-full p-[10px]">
                ...
                <p class="text-[#C72E22]">¿No tienes cuenta? <a href="/register" class="underline">Regístrate</a></p>
                <button type="submit" class="bg-[#C72E22] w-[35%] h-[50px] rounded-[20px] text-[20px] text-[white] cursor-[pointer] hover:border-[2px] hover:border-[#C72E22] hover:text-[#C72E22] hover:bg-[white] transition-colors duration-500 delay-150">Iniciar Sesión</button>
            </form>
        </div>
    </div>
